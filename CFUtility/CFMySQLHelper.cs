...
namespace CF.Utility
{
	class CFMySQLHelper
	{
		/*
		private static readonly string connstring = ConfigurationManager.ConnectionStrings["cf"].ToString();
        ...
        */
		...
		private static readonly string connectionStringManager = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
		...
		{
			MySqlParameter[] parm = {
								   CFMySQLHelper.CreateInParam("@CurrentIndex",  MySqlDbType.Int32,      4,      CurrentIndex    ),
								   CFMySQLHelper.CreateInParam("@PageSize",      MySqlDbType.Int32,      4,      PageSize        ),
								   CFMySQLHelper.CreateInParam("@WhereSql",      MySqlDbType.VarChar,  2500,    WhereSql        ),
								   CFMySQLHelper.CreateInParam("@TableName",     MySqlDbType.VarChar,  20,     TableName       ),
								   CFMySQLHelper.CreateInParam("@Column",        MySqlDbType.VarChar,  2500,    Columns         ),
								   CFMySQLHelper.CreateInParam("@Sort",          MySqlDbType.VarChar,  50,     GetSort(Sort)   ),
								   CFMySQLHelper.CreateOutParam("@RecordCount",  MySqlDbType.Int32,      4                       )
								   };
			return parm;
		}
		/// <summary>
		...
		public static MySqlParameter[] GetCountParm(string TableName, string Columns, string WhereSql)
		{
			MySqlParameter[] parm = {
								   CFMySQLHelper.CreateInParam("@TableName",     MySqlDbType.VarChar,  20,     TableName       ),
								   CFMySQLHelper.CreateInParam("@CountColumn",  MySqlDbType.VarChar,  20,     Columns         ),
								   CFMySQLHelper.CreateInParam("@WhereSql",      MySqlDbType.VarChar,  250,    WhereSql        ),
								   CFMySQLHelper.CreateOutParam("@RecordCount",  MySqlDbType.Int32,      4                       )
								   };
			return parm;
		}
